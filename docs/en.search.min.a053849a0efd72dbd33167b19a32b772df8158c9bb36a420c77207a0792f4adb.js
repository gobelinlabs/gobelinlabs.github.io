...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d1c2268939c289172905ff0778a9da47f468022c9c4b72d026204cf6b045db64.js',function(){input.required=false;search();});}
