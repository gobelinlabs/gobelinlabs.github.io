...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.75530357e9eb748201e44e2490f269ee91d9d6567fd37eb116faf0aa88f475f2.js',function(){input.required=false;search();});}
