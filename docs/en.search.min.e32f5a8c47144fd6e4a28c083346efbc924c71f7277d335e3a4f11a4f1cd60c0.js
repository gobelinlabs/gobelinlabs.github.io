...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fa1610a53e3ded427d5feaa9cf070b8e5b8411639d7d75386d0ec219744222ba.js',function(){input.required=false;search();});}
