...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e0ec2ed1a68f509677215ea25ccd924bf5d9f390ce1917873ac069559ae70fc3.js',function(){input.required=false;search();});}
