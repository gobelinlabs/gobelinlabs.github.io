...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3a9853e03548fecb40e9565f9d0734b337a13bfd61db2ab9b7efabcc5dba1bf8.js',function(){input.required=false;search();});}
