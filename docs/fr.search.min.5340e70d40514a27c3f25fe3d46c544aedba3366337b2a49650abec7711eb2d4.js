...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.53ac442627e4b4cf5bae206c0dbbcaa31d9ad9f1ac68db6ca24df62039d0c3fb.js',function(){input.required=false;search();});}
