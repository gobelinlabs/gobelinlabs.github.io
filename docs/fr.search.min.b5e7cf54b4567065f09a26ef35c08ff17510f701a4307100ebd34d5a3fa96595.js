...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.87932507a25b5c9356e77b328ca82fd641dc57ec667ec3d65ed5ca3958e58b7f.js',function(){input.required=false;search();});}
