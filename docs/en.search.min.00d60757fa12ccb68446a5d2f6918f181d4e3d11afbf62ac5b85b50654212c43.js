...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.06c7d5103aea60631ba3f80db7315f78daddbcbb549d59e4334d70954ee3ccf2.js',function(){input.required=false;search();});}
