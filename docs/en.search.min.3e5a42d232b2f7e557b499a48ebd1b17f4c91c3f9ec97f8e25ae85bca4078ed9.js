...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0ad59c8cbdcbc2a81114bc18c6bd5bf5d706614426862e9ce3609a3b2a1c504d.js',function(){input.required=false;search();});}
